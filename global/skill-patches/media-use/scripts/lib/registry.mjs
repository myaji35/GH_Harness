...
const REGISTRY = {
  ...
  voice: [
    // HeyGen TTS first when credentialed; --local-only skips it and keeps
    // Kokoro as the local fallback. Keyless Edge and optional VibeVoice follow
    // as additional fallbacks.
    P("heygen.tts", { generate: heygenTtsGenerate }),
    A("kokoro.local", { generate: localTtsGenerate }),
    N("edge.tts", { generate: edgeTtsGenerate }),
    A("vibevoice.local", { generate: vibevoiceTtsGenerate }),
  ],
  video: [
